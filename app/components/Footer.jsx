export default function Footer() {
    return (
        <footer className="bg-gradient-to-r from-gray-50 to-gray-100 text-gray-800 py-12 px-4 md:px-8 lg:px-16 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <a href="mailto:msadik3086@gmail.com" className="text-blue-600 hover:underline">msadik3086@gmail.com</a>
                        </div>
                    </div>

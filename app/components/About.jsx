...
export default function About() {
  return (
    <section
      id="about"
      className="scroll-mt-20 flex flex-col-reverse md:flex-row items-center justify-between gap-10 py-12 px-6 md:px-16 lg:px-32 bg-gray-900 transition-colors duration-300"
    >
      ...
      <div className="flex-1 flex justify-center md:justify-start mt-8 md:mt-0">
        <div className="relative group">
          <img
            ...
            className="w-40 h-40 md:w-56 md:h-56 border-4 border-blue-400 shadow-xl object-cover
              transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 animate-fade-in"
          />
          <span className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-blue-400 text-gray-900 text-xs px-4 py-2 rounded-full shadow-lg opacity-90 animate-fade-in-up text-center whitespace-nowrap">
            Software Engineer
          </span>
        </div>
      </div>
